...
use PDF;
class PrintLaporanPengeluaran extends Controller
{
    public function print_laporan_pengeluaran($id)
    {
        ...
        return view('print.print_laporan_pengeluaran', compact('laporan', 'data'));
    }

    public function print_laporan_pengeluaran_a4($id)
    {
        ...
        $pdf = PDF::loadview('print.print_laporan_pengeluaran_a4', compact('laporan', 'data'));

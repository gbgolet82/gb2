...
class ExcelPengeluaranBelumAccController extends Controller
{
    public function exportData(Request $request)
    {
        ...
        $query = DB::table('laporan')->join('klasifikasi_laporan', 'laporan.id_klasifikasi', '=', 'klasifikasi_laporan.id_klasifikasi')
            ->where('klasifikasi_laporan', '!=', 'Pemasukan')->where('laporan.status_cek', 'Belum Dicek');
        ...
        $fileName = sprintf(
            'Laporan Pengeluaran-Belum dicek-%s-%s-%s .xlsx',
            $usaha,
            $filterBulan,
            $filterTahun
        );

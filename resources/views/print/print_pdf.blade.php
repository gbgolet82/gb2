...
<body>
    ...
    <div>
                ...
                <tr>
                    <td style="width:60.1pt; padding-right:5.4pt; padding-left:5.4pt; vertical-align:top;">
                        <p style="margin-top:0pt; margin-bottom:0pt; font-size:12pt;"><span
                                style="font-family:'Times New Roman';">Tanggal</span></p>
                    </td>
                    <td style="width:168pt; padding-right:5.4pt; padding-left:5.4pt; vertical-align:top; ">
                        <p
                            ...
                            <span style="font-family:'Times New Roman';">{{ $filterDaterange }}</span>
                        </p>
                    </td>
                </tr>
                <tr>
        ...
        <div style="text-align: justify;">
            <strong style="float: left; font-family:'Times New Roman'; font-size:12pt;">Total Data : {{ $count }} Data</strong>
            ...
            <tbody>
                <tr>
                    ...
                    <td
                        ...
                        <p style="margin-top:5pt; margin-bottom:5pt; text-align:center; font-size:11pt;"><strong><span
                                    style="font-family:'Times New Roman';">Kode Laporan</span></strong></p>
                    </td>
                    <td
                    ...
                    <td
                        style="width:60pt; border-right-style:solid; border-right-width:0.75pt; border-left-style:solid; border-left-width:0.75pt; border-bottom-style:solid; border-bottom-width:0.75pt; padding-right:5.03pt; padding-left:5.03pt; vertical-align:middle; background-color:#a8d08d;">
                        <p style="margin-top:0pt; margin-bottom:0pt; text-align:center; font-size:11pt;"><strong><span
                                    style="font-family:'Times New Roman';">Kasir</span></strong></p>
                    </td>
                    <td
                        ...
                        <p style="margin-top:0pt; margin-bottom:0pt; text-align:center; font-size:11pt;"><strong><span
                                    style="font-family:'Times New Roman';">Klasifikasi</span></strong></p>
                    </td>
                    <td
                        ...
                        <p style="margin-top:0pt; margin-bottom:0pt; text-align:center; font-size:11pt;"><strong><span
                                    style="font-family:'Times New Roman';">Usaha</span></strong></p>
                    </td>
                    <td
                        style="width:65pt; border-right-style:solid; border-right-width:0.75pt; border-left-style:solid; border-left-width:0.75pt; border-bottom-style:solid; border-bottom-width:0.75pt; padding-right:5.03pt; padding-left:5.03pt; vertical-align:middle; background-color:#a8d08d;">
                        <p style="margin-top:0pt; margin-bottom:0pt; text-align:center; font-size:11pt;"><strong><span
                                    style="font-family:'Times New Roman';">Akun</span></strong></p>
                    </td>
                    <td
                        style="width:60pt; border-right-style:solid; border-right-width:0.75pt; border-left-style:solid; border-left-width:0.75pt; border-bottom-style:solid; border-bottom-width:0.75pt; padding-right:5.03pt; padding-left:5.03pt; vertical-align:middle; background-color:#a8d08d;">
                        <p style="margin-top:0pt; margin-bottom:0pt; text-align:center; font-size:11pt;"><strong><span
                ...
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td
                            style="width:79pt; border-top-style:solid; border-top-width:0.75pt; border-right-style:solid; border-right-width:0.75pt; border-left-style:solid; border-left-width:0.75pt; padding-right:5.03pt; padding-left:5.03pt; vertical-align:top;">
                            ...
                            <p style="margin-top:0pt; margin-bottom:3pt; line-height:115%; font-size:11pt;">
                                @if ($item->status_cek == 'Sudah Dicek')
                                    <span>
                                        <strong style="font-size: 12px; color: #28a745"> {{ $item->status_cek }} </strong>
                                    </span>
                                @else
                                    <span>
                                        <strong style="font-size: 12px; color: #fd7e14"> {{ $item->status_cek }} </strong>
                                    </span>
                                @endif
                            </p>
                        </td>
